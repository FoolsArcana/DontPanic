...
// --------------------------------------------------------------------------
d3.json("/bb/names", function(error, response) {
...
function init(sample) {
    ...
    // ----------------------------------------------------------------------
    d3.json("/bb/samples/" + sample, function(error, sampleResponse) {
        // error trapping for failed call from Flask
        if (error) return console.warn(error);
        ...
        // ------------------------------------------------------------------
        d3.json("/bb/otu_descriptions", function(error, otuResponse) {
        // error trapping for failed call from Flask
        if (error) return console.warn(error);
    ...
    // ----------------------------------------------------------------------
    d3.json("/bb/wfreq/" + sample, function(error, washResponse){
        // error trapping for failed call from Flask
        if (error) return console.warn(error);
...
function optionChanged(chosenSample) {
  ...
  d3.json("/bb/samples/" + chosenSample, function(error, newResponse) {
  // error trapping for failed call from Flask
  if (error) return console.warn(error);
  ...
  d3.json("/bb/otu_descriptions", function(error, newOtuResponse) {
  // error trapping for failed call from Flask
  if (error) return console.warn(error);
  ...
  d3.json("/bb/wfreq/" + chosenSample, function(error, washResponse) {
  // error trapping for failed call from Flask
  if (error) return console.warn(error);
...
function getMetadata(selectedID) {
  d3.json("/bb/metadata/" + selectedID, function(error, response) {
    // error trapping for failed call from Flask
    if (error) return console.warn(error);
